...
def main():
    ...
    p.add_argument("--zenodo_scripts", dest="repository", required=True, help="Folder containing the .nwk files")
    ...
    if not rows:
        sys.exit("No valid tree pairs matched. Verification of paths or zenodo_scripts required.")
